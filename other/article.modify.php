                ...
                <section class="content-secondary col-md-6">
                    <form role="form" id="form1" name="form1" method="post" action="article.modify.handle.php">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" name="description" id="description" placeholder="内容...（小于100字）"><?php echo $data['description']?></textarea>
                          </div>
                        
                          <div class="form-group">
                            <label for="content">文章内容</label>
                            <textarea class="form-control" rows="10" name="content" id="content" placeholder="文章内容..."><?php echo $data['content']?></textarea>
                          </div>
